...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.push.js */ \"./node_modules/core-js/modules/es.array.push.js\");\n/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! axios */ \"./node_modules/axios/lib/axios.js\");\n/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! js-cookie */ \"./node_modules/js-cookie/dist/js.cookie.mjs\");\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue */ \"./node_modules/vue/dist/vue.esm-bundler.js\");\n/* harmony import */ var _YesNoModal_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../YesNoModal.vue */ \"./src/components/YesNoModal.vue\");\n/* harmony import */ var _TableHeaderCard_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../TableHeaderCard.vue */ \"./src/components/TableHeaderCard.vue\");\n/* harmony import */ var _SnackBar_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../SnackBar.vue */ \"./src/components/SnackBar.vue\");\n\n\n\n\n\n\n\nconst baseUrl = \"http://127.0.0.1:9015/\";\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  components: {\n    YesNoModal: _YesNoModal_vue__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n    TableHeaderCard: _TableHeaderCard_vue__WEBPACK_IMPORTED_MODULE_4__[\"default\"],\n    SnackBar: _SnackBar_vue__WEBPACK_IMPORTED_MODULE_5__[\"default\"]\n  },\n  data() {\n    return {\n      attrs: {\n        class: 'mb-6',\n        boilerplate: true,\n        elevation: 2\n      },\n      dialog: false,\n      formIsValid: true,\n      headers: [{\n        title: 'Transaction',\n        align: 'start',\n        sortable: false,\n        key: 'info'\n      }, {\n        title: 'Amount (IDR)',\n        align: 'start',\n        sortable: true,\n        key: 'amount'\n      }, {\n        title: 'Date',\n        align: 'start',\n        sortable: true,\n        key: 'date'\n      }, {\n        title: 'Detail',\n        align: 'start',\n        sortable: false,\n        key: 'details'\n      }, {\n        title: 'Category',\n        align: 'start',\n        sortable: true,\n        key: \"category\"\n      }],\n      items: [],\n      selectedItems: [],\n      categories: [],\n      selectAll: false,\n      yesNoModalObj: {\n        trigger: false,\n        dialog: {\n          title: \"New Transactions\",\n          text: \"Looks like you just uploaded a bankstatement, want to label transactions from that bankstatement?\"\n        }\n      },\n      snackBarObj: {\n        trigger: false,\n        dialog: \"Please select and label transactions first!\"\n      },\n      tableIsLoading: false,\n      balance_summary: []\n    };\n  },\n  props: {\n    cached_transactions_data: null,\n    account_types: null,\n    cached_summary: [],\n    transactions: []\n  },\n  methods: {\n    postTransactions() {\n      axios__WEBPACK_IMPORTED_MODULE_6__[\"default\"].defaults.headers.common['X-CSRFToken'] = js_cookie__WEBPACK_IMPORTED_MODULE_1__[\"default\"].get('csrftoken');\n      const CRUDBankstatementAPI = `${baseUrl}bankstatement/api/CRUDBankstatementAPI`;\n      axios__WEBPACK_IMPORTED_MODULE_6__[\"default\"].post(CRUDBankstatementAPI, {\n        transactions: this.selectedItems,\n        balance_summary: this.getBalanceSummary(this.selectedItems)\n      }).then(response => {\n        // Process the response data\n        this.tableIsLoading = false;\n        let data = response.data;\n        console.log(data);\n        return data;\n      }).catch(error => {\n        // Handle any error that occurs\n        this.tableIsLoading = false;\n        console.error(error);\n      });\n    },\n    toggleAllCheckboxes() {\n      this.items.forEach(item => {\n        item.select = this.selectAll;\n      });\n    },\n    getBalanceSummary(selectedItems) {\n      let period_keys = [];\n      let balance_summaries = [];\n      let tmp_balance_summary = (0,vue__WEBPACK_IMPORTED_MODULE_2__.toRaw)(this.balance_summary);\n      for (const element of selectedItems) {\n        let tmp_date = element.date.split('-');\n        let item_period_key = `${tmp_date[1]}-${tmp_date[2]}`;\n        if (!period_keys.includes(item_period_key)) {\n          period_keys.push(item_period_key);\n          balance_summaries.push(tmp_balance_summary[item_period_key]);\n        }\n      }\n      return balance_summaries;\n    },\n    formatPrice(value) {\n      let val = (value / 1).toFixed(2).replace('.', ',');\n      return val.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \".\");\n    },\n    processCategorySelect(account_types) {\n      let categories = [{\n        key: null,\n        name: null\n      }];\n      account_types.forEach(category => categories.push({\n        key: category,\n        name: category\n      }));\n      this.categories = categories;\n    },\n    getCachedData() {\n      this.items = this.cached_transactions_data;\n      this.balance_summary = this.cached_summary;\n    },\n    validateForm() {\n      this.tableIsLoading = true;\n      let safeToSubmit = false;\n      this.selectedItems = [];\n      const NO_ITEM_SELECTED = this.items.filter(item => item.select).length < 1;\n      const NO_ITEM = this.items.length < 1;\n      if (NO_ITEM || NO_ITEM_SELECTED) {\n        this.$refs.errorSnackbar.popSnackBar(\"Please Selecet or Load Transactions First!\");\n        this.tableIsLoading = false;\n        return;\n      }\n      this.items.forEach(item => {\n        if (item.select) {\n          this.selectedItems.push(item);\n          item.error = !item.account_type;\n          safeToSubmit = item.account_type;\n        }\n      });\n      if (!safeToSubmit) {\n        this.$refs.errorSnackbar.popSnackBar(\"Please Complete Labeling Your Transactions\");\n        this.tableIsLoading = false;\n      } else if (this.selectedItems.length < this.items.length && safeToSubmit) {\n        this.$refs.confirmSubmissionModal.toggleModal({\n          \"title\": \"Confirm Submission!\",\n          \"text\": \"You haven't selected all of the items yet! Are you sure you want to submit the selected items?\"\n        });\n      } else {\n        this.$refs.confirmSubmissionModal.toggleModal({\n          \"title\": \"Confirm Submission!\",\n          \"text\": \"Looks good! Click 'yes' to save.\"\n        });\n      }\n    }\n  },\n  watch: {\n    transactions() {\n      this.$refs.errorSnackbar.popSnackBar(\"Loading data to table...\");\n      this.items = this.transactions;\n    }\n  },\n  mounted() {\n    this.cached_transactions_data ? this.$refs.loadCachedItemModal.toggleModal({\n      \"title\": \"New Transactions\",\n      \"text\": \"Would you like to load and label the newly uploaded transactions?\"\n    }) : null;\n    this.processCategorySelect(this.account_types);\n  }\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/ViewTransactionsLabeling/TransactionsTable.vue?vue&type=script&lang=js\n");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! axios */ \"./node_modules/axios/lib/axios.js\");\n/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! js-cookie */ \"./node_modules/js-cookie/dist/js.cookie.mjs\");\n/* harmony import */ var _TransactionsTable_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TransactionsTable.vue */ \"./src/components/ViewTransactionsLabeling/TransactionsTable.vue\");\n/* harmony import */ var _TableHeaderCard_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../TableHeaderCard.vue */ \"./src/components/TableHeaderCard.vue\");\n/* harmony import */ var _vuepic_vue_datepicker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @vuepic/vue-datepicker */ \"./node_modules/@vuepic/vue-datepicker/dist/vue-datepicker.js\");\n/* harmony import */ var _vuepic_vue_datepicker_dist_main_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @vuepic/vue-datepicker/dist/main.css */ \"./node_modules/@vuepic/vue-datepicker/dist/main.css\");\n/* harmony import */ var _vuepic_vue_datepicker_dist_main_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vuepic_vue_datepicker_dist_main_css__WEBPACK_IMPORTED_MODULE_4__);\n\n\nconst baseUrl = \"http://127.0.0.1:9015/\";\n\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  data() {\n    return {\n      date: null,\n      transactions: [],\n      balance_summaries: []\n    };\n  },\n  components: {\n    TransactionsTable: _TransactionsTable_vue__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n    TableHeaderCard: _TableHeaderCard_vue__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n    VueDatePicker: _vuepic_vue_datepicker__WEBPACK_IMPORTED_MODULE_3__[\"default\"]\n  },\n  methods: {\n    getTransactions() {\n      axios__WEBPACK_IMPORTED_MODULE_5__[\"default\"].defaults.headers.common['X-CSRFToken'] = js_cookie__WEBPACK_IMPORTED_MODULE_0__[\"default\"].get('csrftoken');\n      const getTransactionsUrl = `${baseUrl}bankstatement/api/CRUDBankstatementAPI`;\n      axios__WEBPACK_IMPORTED_MODULE_5__[\"default\"].get(getTransactionsUrl, {\n        params: {\n          start_period: this.formatDatePeriod()[0],\n          end_period: this.formatDatePeriod()[1]\n        }\n      }).then(response => {\n        // Process the response data\n        let data = response.data.data;\n        console.log(data);\n        organizeTransactionData(data);\n      }).catch(error => {\n        // Handle any error that occurs\n        console.error(error);\n      });\n    },\n    formatDatePeriod() {\n      let start_date = this.date[0];\n      let end_date = this.date[1] ? this.date[1] : this.date[0];\n      let start_period = `${start_date.month}-${start_date.year}`;\n      let end_period = `${end_date.month}-${end_date.year}`;\n      return [start_period, end_period];\n    },\n    organizeTransactionData(data) {}\n  }\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/ViewTransactionsLabeling/ViewTransactionsLabeling.vue?vue&type=script&lang=js\n");
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "741110565afc430a"; }
/******/ 	}();
/******/ 	
...
/******/ 	__webpack_require__.O(undefined, ["chunk-vendors"], function() { return __webpack_require__("./node_modules/webpack-dev-server/client/index.js?protocol=ws&hostname=192.168.110.213&port=8080&pathname=%2Fws&logging=none&progress=true&overlay=%7B%22errors%22%3Atrue%2C%22warnings%22%3Afalse%7D&reconnect=10&hot=true&live-reload=true"); })
