<template>
  ...
  export default {
    ...
    methods:{
      sendUpdateDate(){
        alert(`Range selected with the second date`);
...
<style>
/* Custom styles for Vuetify date picker */
:root {
  ...
  --dp-row-margin:  1px 0; /*Adjust the spacing between rows in the calendar*/
...
.dp__theme_light {
  ...
  --dp-primary-color: rgb(2, 152, 67);
  --dp-primary-disabled-color: #6bacea;
  --dp-primary-text-color: #f8f5f5;
  --dp-secondary-color: #c0c4cc;
  --dp-border-color: #4d1010;
  ...
  --dp-range-between-dates-background-color: var(--dp-hover-color, rgb(79, 79, 79));
  --dp-range-between-dates-text-color: var(--dp-hover-text-color, #212121);
  --dp-range-between-border-color: var(--dp-hover-color, #858282);
}
</style>